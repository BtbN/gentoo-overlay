...
inherit git-r3 autotools-utils bash-completion-r1 linux-info systemd user readme.gentoo toolchain-funcs vala virtualx udev eutils
...
src_prepare() {
	...
	sed -i "s|^completiondir =.*|completiondir = $(get_bashcompdir)|" \
		clients/cli/Makefile.am || die "sed completiondir failed"
