...
SRC_URI="amd64? ( http://dl.4players.de/ts/releases/pre_releases/server/${PV/_beta/-Beta-}/teamspeak3-server_linux_amd64-${PV::-6}.tar.bz2 -> teamspeak3-server_linux_amd64-${PV}.tar.bz2 )
	x86? ( http://dl.4players.de/ts/releases/pre_releases/server/${PV/_beta/-Beta-}/teamspeak3-server_linux_x86-${PV::-6}.tar.bz2 -> teamspeak3-server_linux_x86-${PV}.tar.bz2 )"
